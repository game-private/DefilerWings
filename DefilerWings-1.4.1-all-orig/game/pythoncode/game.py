...
#            del self.history_mod[remove_this[j]]
    ...
    def choose_spell(self, back_message=u"Вернуться"):
        ...
        for spell in self.spell_list.keys():
            ...
            if spell not in self.dragon.spells and self.spell_list[spell][0] not in self.dragon.modifiers() and (spell != 'spellbound_trap' or 'magic_traps' not in self.lair.upgrades):
