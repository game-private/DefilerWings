            ...
            grid girls_cols 1:
                ...
                for col_i in xrange(girls_cols):
                    ...
                    if girl_i < game.girls_list.prisoners_count:
                      # @fdsc Выделяем девственниц и бордельщиц разными цветами
                      $ cur = game.girls_list.prisoners[girl_i]
                      if not cur.virgin and cur.in_brothel and cur.years_in_brothel < 1 or cur.pregnant > 0:
                          imagebutton:
                          ...
                          $ color = "#00FF00"
                          if cur.virgin and not cur.in_brothel:
                            $ color = "#FF0000"
                          elif cur.virgin and cur.in_brothel:
                            $ color = "#FFFFFF"
                          elif not cur.virgin and cur.in_brothel and cur.years_in_brothel == 1:
                            $ color = "#555500"
                          elif not cur.virgin and cur.in_brothel and cur.years_in_brothel == 2:
                            $ color = "#FFFF00"
                          elif not cur.virgin and cur.in_brothel and cur.years_in_brothel == 3:
                            $ color = "#000088"
                          elif not cur.virgin and cur.in_brothel and cur.years_in_brothel > 3:
                            $ color = "#0000FF"
