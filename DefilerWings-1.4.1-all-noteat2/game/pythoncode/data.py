...
quest_list = (
    ...
    {   # @fdsc Поставить в армию много девушек
        'min_lvl': 6,  # минимальный уровень дракона для получения квеста
        'max_lvl': 12,  # максимальный уровень дракона для получения квеста
        # текст квеста, {0} будет заменён на требуемый уровень
        'text': u"В этот раз тебе придётся позаботиться о морали твоей армии. Солдатам требуются девушки для развлечений и размножения. Сделай так, чтобы ко мне на службу поступило не менее {0} девушек\n\nУточнение: девушки и альвы влюбляются в ящериков (состоящих в охране бойцов, рождённых от аристократок). Девушки после ухаживания влюбляются быстрее",
    ...
    {   # @fdsc Поставить в армию элитных бойцов
        'min_lvl': 6,  # минимальный уровень дракона для получения квеста
        'max_lvl': 12,  # максимальный уровень дракона для получения квеста
        # текст квеста, {0} будет заменён на требуемый уровень
        'text': u"На стороне жалких людишек и их прихлебателей сражаются ангелы, титаны, механизмы цвергов. Чтобы их победить, нашей армии нужны элитные бойцы: собери {0} элитных бойцов", # game.army.elites
        'fixed_time': 75,
        'task': 'elite',
        'fixed_threshold': -5,  # задаёт фиксированное значения для задачи
        # число, на которое нужно умножить уровень дракона, чтобы получить необходимый уровень
        'lvlscale_threshold': 3,
    },
    {   # Набрать сокровищ
        'min_lvl': 6,  # минимальный уровень дракона для получения квеста
