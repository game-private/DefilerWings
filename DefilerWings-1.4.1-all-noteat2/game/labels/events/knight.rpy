...
#    "Рыцарь выполняет квест и получает [item.name]"
    if item.id == "glittering_vest":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир и получил в награду сверкающий доспех." 
    elif item.id == "gold_vest":
      "{color=#FFFF00}[game.knight.name] заметил богатый кортеж, атакованный бандой ящериков, и стремглав бросился на помощь. После битвы выяснилось, что в карете ехала юная и прелестная аристократка. В награду за спасение своей дочери герцог подарил рыцарю прекрасный золочёный доспех." 
    elif item.id == "magic_vest":
      "{color=#FFFF00}[game.knight.name] нашёл логово демонопоклонников и одолел мерзких сектантов. В самом логове он нашёл прекрасную альву, привязанную к алтарю, но целую и невредимую. [game.knight.title] проводил её до священных лесов. В награду за спасение Дочь Дану подарила рыцарю доспех, зачарованный самыми мудрыми друидами её народа." 
    elif item.id == "blued_spear":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир и получил в награду воронёное копьё." 
    elif item.id == "spear_with_scarf":
      "{color=#FFFF00}[game.knight.name] заметил банду ящериков, орудующую на остатках разорённого кортежа, и стремглав бросился на помощь. После короткой и напряжённой схватки ящерики отступили. Увы, [game.knight.title] не смог помочь ни защитникам, ни юной аристократке, принявшей мученическую смерть в лапах кровожадных чудовищ. [game.knight.name] взял с её тела ажурный шарф и повязал его на своё копьё, поклявшись, что эта ужасная история никогда не повторится впредь." 
    elif item.id == "dragonslayer_spear":
      "{color=#FFFF00}[game.knight.name] обнаружил заброшенные руины, настолько древние, что даже самые мудрые из альвов вряд ли смогли бы что-то сказать об их создателях. Проникнув в подземелья, истребив множество монстров и преодолев бесчисленное количество ловушек, [game.knight.title] обнаружил копьё, созданное в незапамятные времена специально для охоты на гигантских ящеров.{/color}"
    elif item.id == "glittering_sword":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир и получил в награду сияющий меч."   
    elif item.id == "lake_woman_sword":
      "{color=#FFFF00}Путешествуя вдоль берега озера, [game.knight.name] заметил юную, прекрасную и очень грустную воительницу. После короткого разговора выяснилось, что озёрная дева пришла сюда из иного мира. [game.knight.title] рассказал ей о злодеяних дракона, и дева подарила ему один из своих клинков, после чего ускакала прочь и исчезла в сгустившемся тумане. [game.knight.name] до конца дней своих  жалел о том, что так и не расслышал имя Владычицы озера. Вроде бы, что-то на 'Ц'?"  
    elif item.id == "flameberg_sword":
      "{color=#FFFF00}[game.knight.name] путешествовал вдоль границы Ифритистана, там, где  воздух наполнен пеплом, а далёкие вулканы подпирают небо тёмными, клубящимися столбами. Внезапно [game.knight.title] увидел меч, воткнутый в огромный валун. Удивившись, рыцарь подошёл и попытался вытащить его. Сначала клинок сидел намертво, как и положено любому уважающуму себя мечу в камне. Но стоило только рыцарю подумать о сражении с драконом, как пылающий фламберг с лёгкостью вышел из монолитного валуна!{/color}"
    elif item.id == "icecracker_sword":
      "{color=#FFFF00}Как-то раз [game.knight.name] услышал об убийстве, совершённом в соседнем городе. Приехав на место преступления, рыцарь обнаружил, что убийца уже пойман. Да и убитый был известным смутьяном, долгое время подстрекавшим против королевской власти. Обычная история, вот только [game.knight.title] очень заинтересовался орудием убийства. Магистрат городка пошёл ему навстречу, и рыцарь заполучил ледоруб-жидобой." 
    elif item.id == "thunderer_sword":
      "{color=#FFFF00}Как-то раз [game.knight.name] услышал о птице рух, похищавшей в предгорьях скот и людей. Долго [game.knight.title] искал гнездо этой твари, выматывающей и тяжёлой была схватка с монстром. После победы рыцарь забрал металлические когти птицы рух, а столичный кузнец выковал из них замечательный меч-громобой."    
    elif item.id == "polished_shield":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир и получил в награду полированный щит."   
    elif item.id == "mirror_shield":
      "{color=#FFFF00}Как-то раз, странствуя вдоль побережья, [game.knight.name] увидел героя в старинном доспехе, сражавшегося с Медузой Горгоной. [game.knight.title] с радостью помог своему коллеге. В благодарность за помощь герой подарил рыцарю свой зерцальный щит." 
    elif item.id == "white_horse":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир и получил в награду белого коня.{/color}"
    elif item.id == "pegasus":
      "{color=#FFFF00}Стоя не высоком утёсе, [game.knight.name] обозревал земли Вольных.  Незасеянные поля, проплешины от пожаров, новые кладбища... безрадостная картина. Внезапно [game.knight.title] услышал громкое ржание, и прямо с небес к нему опустился крылатый пегас. Необычайный конь склонил голову и посмотрел на рыцаря не по-лошадиному умным взглядом. Пегас как будто спрашивал рыцаря: 'Доколе? Доколе будет длится всё это?' 'Недолго', - ответил [game.knight.name], - 'С тобой - недолго'{/color}"
    elif item.id == "firehorse":
      "{color=#FFFF00}[game.knight.name] опоздал. Когда он добрался до обречённого села, патруль уже добивал остатки банды ящериков, а само село пылало жарким пламенем. Выли от отчаяния немногие выжившие, потерявшие родных и близких. Внезапно в языках огня проступил силуэт лошади. Не успели присутсвующие и глазом моргнуть, как перед рыцарем стоял огненно-рыжий конь, в нетерпении бивший копытом. Кажется, ему тоже надоели злодеяния отродий Тёмной Госпожи.{/color}"
    elif item.id == "sivka":
      "{color=#FFFF00}Как-то раз, странствуя поздней ночью, [game.knight.name] увидел коня, топчущего поле пшеницы. Да какого коня - одна шерстинка серебряная, другая золотая, бежит — земля дрожит, из ушей дым столбом валит, из ноздрей пламя пышет. Подкрался к коню рыцарь, накинул верёвку на шею, да и оседлал. Долго пытался скинуть его конь, а когда не смог - заговорил человеческим голосом, да сказал своё имя. С тех пор [game.knight.title] всегда мог вызвать коня, стоило только свистнуть три раз, да крикнуть погромче: 'Сивка-Бурка, вещая каурка, стань передо мною, как лист перед травою!'{/color}"
    elif item.id == "kelpie":
      "{color=#FFFF00}Как-то раз [game.knight.name] в задумчивости сидел на берегу озера. Проклятый ящер ускользал как вода сквозь пальцы, творя злодеяния во всех уголках Земель Вольных. Внезапно спокойные воды вспенились, и из глубин поднялся прекраснейший белоснежный конь. Кельпи бил копытом по водной глади и косил на рыцаря прозрачным глазом, как будтно подбадривая: 'Не бойся. Теперь я с тобой'{/color}"
    elif item.id == "griffon":
      "{color=#FFFF00}[game.knight.name] долго помогал цвергам. Он охранял их корованы, патрулировал местность перед входом в пещеры, сражался с монстрами на горных склонах и в подземных глубинах. И когда [game.knight.title] прокачал репутацию с цвергами до 'Превознесения', они подарили ему прекрасного белоснежного грифона.{/color}"
    elif item.id == "squire":
      "{color=#FFFF00}Как-то раз, готовясь спасти очередного котёнка с дерева, [game.knight.name] заметил, что его кто-то опередил. Ловкий парнишка в два счёта забрался в головокружительную высь и бесстрашно снял с тонюсенькой веточки жалобно пищащий комочек меха. 'Впечатляет', - заметил [game.knight.title], когда спасатель спустился вниз, - 'Мне такой оруженосец не помешает. Хочешь присоединиться ко мне?' Ловкий парнишка жизнерадостно улыбнулся. 'С удовольствием, сэр рыцарь!'{/color}"
    elif item.id == "veteran":
      "{color=#FFFF00}[game.knight.name] выиграл рыцарский турнир. Закалённый ветеран, впечатлённый его успехами, решил присоединиться к рыцарю.{/color}"
    elif item.id == "pythoness":
      "{color=#FFFF00}[game.knight.name] медленно шёл вдоль рядов деревенской ярмарки. Внезапно к нему подошла юная девушка. 'Вы собираетесь идти на дракона', - сказала она, - 'Я должна быть с вами. Я вижу будущее.' [game.knight.title] опешил. 'Мы победим?' - неуверенно спросил он. Ясновидящая спокойно пожала плечами. 'Не знаю. Но без меня ваши шансы гораздо ниже.'{/color}"
      $ game.knight.year=game.year-18
    elif item.id == "thaumaturge":
      "{color=#FFFF00}[game.knight.name] ехал в чистом поле, и тут внезапно из-за угла вышел старик. Массивный посох, остроконечная шляпа с широкими полями, рассшитая звёздами мантия, белоснежная борода и усы. 'Значит, ты решил победить дракона?' - грозно спросил незнакомец. [game.knight.title] невесть с чего стушевался и пробормотал: 'Я попытаюсь.' Старик дружелюбно усмехнулся в густые усы. 'Не надо пытаться. Делай. Или не делай.'{/color}"
