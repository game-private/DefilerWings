...
label lb_event_knight_talk_innocent(knight,girl):
    ...
    if girl.willing:
      ...
      if game.dragon.energy() > 0:
        'Дракон проснулся, почувствовав опасность для юного тела и защитил девушку'
      else:
        'Спросоня дракон повредил самого себя в спешке, пытаясь спасти девушку'
        $ game.dragon.struck()

      $ game.dragon.drain_energy()

      $ text = u'%s %s пришёл в логово дракона, чтобы освободить %s. Но когда пленница заявила, что дракон её любит, рыцарь пришёл в ярость и попытался обезглавить эту приспешницу Тёмной Госпожи. Почувствовав угрозу, дракон проснулся и защитил девушку \n\n' % (knight.title,knight.name,girl.name_v)
      $ game.chronik.write_chronik(text,game.dragon.level,game.girl.girl_id)
