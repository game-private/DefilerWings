...
label lb_love_lizardman_mistress:
    ...
    if random.randint(1,5)==-1: # Проигрыш ящерика # @fdsc Ящерики никогда не проигрывают: девочек жалко
      ...
      if random.randint(1,5)==1:
        ...
        '{color=#FF0000}Ящерик споткнулся от усталости, но [game.dragon.name] хорошо помнит своих слуг. Он мысленно дал ему ещё энергии, чтобы ящерик смог победить.{/color}'
