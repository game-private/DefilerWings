...
label lb_location_city_main:
    ...
    menu:
        ...
        'Украсть девушку с рынка' if game.dragon.can_fly and not (game.witch_st1==6 or game.witch_st1==7) and game.dragon.energy() > 0 and game.girl is not None and game.girls_list.free_size-game.girl.size >= 0:
            # @fdsc
